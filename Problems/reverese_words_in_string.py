...
Follow-up: If the string data type is mutable in your
language, can you solve it in-place with O(1) extra space?
"""
...
def tests():
    s = "the sky is blue"
    res = reverse_words(s)
    print(f"reversed words for string '{s}' are '{res}'")
